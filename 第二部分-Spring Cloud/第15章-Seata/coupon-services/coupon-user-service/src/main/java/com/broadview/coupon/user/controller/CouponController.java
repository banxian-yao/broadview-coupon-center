...
public class CouponController {
    ...
    public Integer inactiveCoupon(@RequestParam("templateId") Long templateId) throws InterruptedException {
        return couponUserService.inactiveCouponTemplate(templateId);
    }
}
